  ...
  <office:document-content xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:fo="urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:meta="urn:oasis:names:tc:opendocument:xmlns:meta:1.0" xmlns:number="urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0" xmlns:chart="urn:oasis:names:tc:opendocument:xmlns:chart:1.0" xmlns:dr3d="urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0" xmlns:math="http://www.w3.org/1998/Math/MathML" xmlns:form="urn:oasis:names:tc:opendocument:xmlns:form:1.0" xmlns:script="urn:oasis:names:tc:opendocument:xmlns:script:1.0" xmlns:ooo="http://openoffice.org/2004/office" xmlns:ooow="http://openoffice.org/2004/writer" xmlns:oooc="http://openoffice.org/2004/calc" xmlns:dom="http://www.w3.org/2001/xml-events" xmlns:xforms="http://www.w3.org/2002/xforms" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" office:version="1.0">
   ...
   <office:automatic-styles>
    ...
    <style:style style:name="co18" style:family="table-column">
     <style:table-column-properties fo:break-before="auto" style:column-width="18.000cm"/>
    </style:style>
   ...
   <office:body>
    <office:spreadsheet>
     <table:table>
      ...
      <table:table-row>
       <table:table-cell><text:p>Test DATE</text:p></table:table-cell>
       <table:table-cell><text:p>Test Name [FOLDER]</text:p></table:table-cell>
       <table:table-cell><text:p>Test Type</text:p></table:table-cell>
       <table:table-cell><text:p>Input File</text:p></table:table-cell>
       <table:table-cell><text:p>Scene</text:p></table:table-cell>
       <table:table-cell><text:p>Result [FDS file comparison]</text:p></table:table-cell>
       <table:table-cell><text:p>Result [FDS execution]</text:p></table:table-cell>
       <table:table-cell><text:p>Note [FDS file comparison]</text:p></table:table-cell>
       <table:table-cell><text:p>Note [FDS execution]</text:p></table:table-cell>
      </table:table-row>

      <!-- Process XML input: Insert one row for each payment -->
      <xsl:for-each select="testResults/Results">
      <xsl:for-each select="Case">
       <table:table-row>
        ...
        <table:table-cell>
         <text:p><xsl:value-of select="Input"/></text:p>
        </table:table-cell>

        <table:table-cell>
         <text:p><xsl:value-of select="Scene"/></text:p>
        </table:table-cell>

        <table:table-cell>
         <text:p><xsl:value-of select="Result"/></text:p>
        </table:table-cell>

        <table:table-cell>
         <text:p><xsl:value-of select="Result_Fds"/></text:p>
        </table:table-cell>

        <table:table-cell>
         <text:p><xsl:value-of select="Note"/></text:p>
        </table:table-cell>

        <table:table-cell>
         <text:p><xsl:value-of select="Node_Fds"/></text:p>
        </table:table-cell>
