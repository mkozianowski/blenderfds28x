...
class BFNamelist(BFParam):
    ...
    # tuple of managed classes of type BFParam
    # used for auto drawing panel, exporting
    bf_params = tuple()
    # dict of classes of type BFParam by fds_label (autogenerated)
    # used for importing
    bf_params_by_fds = dict()
    # class classes of type BFParamOther used for other parameters
    bf_param_other = None
